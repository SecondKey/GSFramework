...
//        #region NewObject
//        public T GetNewObject<T>(string scriptID = "", string performer = "", Dictionary<string, object> parameters = null)
//        {
//            object tmp = GetNewObject(typeof(T).FullName, scriptID, performer, parameters);
//            if (tmp == null)
//            {
//                return default;
//            }
...
//        public object GetNewObject(Type scriptType, string scriptID = "", string performer = "", Dictionary<string, object> parameters = null)
//        {
//            return GetNewObject(scriptType.FullName, scriptID, performer, parameters);
//        }

//        public object GetNewObject(string scriptType, string scriptID, string performer = "", Dictionary<string, object> parameters = null)
//        {
//            if (parameters == null)
//            {
...
//                if (performer == "")
//                {
//                    tmpObject = c.GetMapping(scriptType, scriptID).CreateInstence();
//                }
//                if (tmpObject == null)
//                {
